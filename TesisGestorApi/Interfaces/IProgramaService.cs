...
namespace TesisGestorApi.Interfaces
{
    ...
    {
        Task<List<ProgramaResumenDto>> GetProgramasPorECAsync(Guid idEC, CancellationToken ct);
        Task<ProgramaDetalleDto> GetProgramaAsync(Guid idPrograma, CancellationToken ct);
